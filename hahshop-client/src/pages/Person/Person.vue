  ...
  <section class="profile">
    ...
    <section class="profile-number">
      <router-link :to="userInfo._id ?'/userinfo' : '/login'" class="profile-link">
        <div class="profile_image">
          <i class="iconfont icon-person icon-yonghu-fuben"></i>
        </div>
        <div class="user-info">
        ...
        <span class="arrow">
              <i class="iconfont icon-jiantou1 icon-iconfonticonfonti2copycopy"></i>
            </span>
      </router-link>
    ...
    <section class="profile_my_order border-1px">
      ...
      <a href='javascript:' class="my_order">
            <span>
              <i class="iconfont icon-order-s icon-dingdan2"></i>
            </span>
      ...
      <a href="javascript:" class="my_order">
            <span>
              <i class="iconfont icon-vip icon-huiyuan_huaban1"></i>
            </span>
        <div class="my_order_div">
          <span>  哈哈会员专享</span>
          <span class="my_order_icon">
