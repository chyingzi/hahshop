  ...
  <div class="shop-header">
    ...
    <nav class="shop-nav" :style="{backgroundImage:`url(${infos.bgImg})`}">
      <a class="back" @click="$router.back()">
        <i class="iconfont icon-arrow_left icon-arrowLeft-fill" ></i>
      </a>
    </nav>
    <div class="shop-content" @click="toggleShopShow">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">月售 {{infos.sellCount}} 单</span>
          <span class="shop-message-detail">
            {{ infos.description }}
            <span>约 {{infos.deliveryTime}} 分钟</span>
          </span>
          <span class="shop-message-detail">距离 {{infos.distance}}</span>
        </div>
      </div>
    </div>
    <div class="shop-header-discounts" v-if="infos.supports" @click="toggleSupportShow">
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[infos.supports[2].type]">
          <span class="content-tag">
      ...
      <div class="shop-brief-modal" v-show="shopShow" >
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="toggleShopShow">
            <span class="iconfont icon-close icon-guanbi"></span>
          </div>
        </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow" >
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item"  v-for="(support,index) in infos.supports" :key="index" :class="supportClasses[ support.type]">
            <span class="content-tag">
